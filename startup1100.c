...
#define	CLK_SEL	0			/* Main clock selection = 0:IRC(12MHz), 1:PLL-in, 2:WDT or 3:PLL-out */
...
#define	MCLK	12000000	/* Expected main clock frequency = F_OSC * (CLK_SEL == 3 ? PLL_M : 1) */
